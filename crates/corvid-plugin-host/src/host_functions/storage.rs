...
pub fn link(linker: &mut Linker<PluginState>) -> anyhow::Result<()> {
    ...
    linker.func_wrap("env", "host_kv_get", |_caller: wasmtime::Caller<'_, PluginState>, _key_ptr: i32, _key_len: i32| -> i32 {
    ...
    linker.func_wrap("env", "host_kv_set", |_caller: wasmtime::Caller<'_, PluginState>, _key_ptr: i32, _key_len: i32, _val_ptr: i32, _val_len: i32| -> i32 {
        // Full implementation will:
